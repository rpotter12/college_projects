/*  c++ mini project for flight booking system. Array variables which are using in this program are:
 *  route - this will store source destination route.
 *  fare - this wil store fare against defined route.
